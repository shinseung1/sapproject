      ...
      <tbody>
        <c:forEach var="blogVO" items="${list }">
          <tr>
            ...
            <td style='vertical-align: middle;'>
              <a href="./read.do?blogno=${blogVO.blogno}&categoryno=${blogVO.categoryno}&word=${param.word}&nowPage=${param.nowPage}">${blogVO.title}</a> 
            </td> 

            <td style='vertical-align: middle;'>${blogVO.rdate.substring(0, 16)}</td>
            <td style='vertical-align: middle;'>${blogVO.good}</td>
            <td style='vertical-align: middle;'>
              <a href="./update.do?blogno=${blogVO.blogno}&categoryno=${blogVO.categoryno}&nowPage=${param.nowPage}&word=${param.word}"><img src="./images/update.png" title="수정" border='0'/></a>
              <a href="./delete.do?blogno=${blogVO.blogno}&categoryno=${blogVO.categoryno}&nowPage=${param.nowPage}&word=${param.word}"><img src="./images/delete.png" title="삭제"  border='0'/></a>
              ${blogVO.categoryno}
            </td>
          </tr>
        </c:forEach>
