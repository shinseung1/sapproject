...
<DIV class='content'>     
  ...
  <ASIDE style='float: left;'>
    ...
    >  
    <A href='./list_by_categoryno.do?categoryno=${categoryVO.categoryno }&word_find=${word_find}'>${categoryVO.title }</A>
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' method='POST' action='./reply.do'
      ...
      <div class="form-group">   
        ...
        <div class="col-md-11">
          <input type='text' class="form-control input-lg" name='title' id='title' value='바다건너' required="required" style='width: 80%;'>
        </div>
      </div>   
      <div class="form-group">   
