...
.categrp_name{
  margin-left: 5%;
  font-weight: bold;
  list-style-image: url("${pageContext.request.contextPath}/category/images/categrp.gif");
}

/* 카테고리에 적용, Spring에서 사용 */
.category_title{
  margin-left: 5%;
  list-style-image: url("${pageContext.request.contextPath}/category/images/category.gif");
}
</style>
...
<fieldset class='categrp_category_left' >
  ...
  <DIV>
    ...
    <A href="${pageContext.request.contextPath}/blog/list_all_category.do">전체 보기</A>
