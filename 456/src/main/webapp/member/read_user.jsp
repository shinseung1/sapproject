...
<DIV class='content'>
  ...
  <ASIDE style='float: left;'>
      <A href='./member/list.do'>회원 정보 조회</A>  
  </ASIDE>
  ...
  <FORM name='frm' id='frm' method='POST' action='./update_user.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='id' id='id' value='${memberVO.id }' required="required" style='width: 30%;' placeholder="아이디" autofocus="autofocus">
